...
head:
  - - meta
    - name: keywords
      content: rails api, ruby on rails, openremote, api documentation, 22 models, 6 controllers, 7 services, 514 examples, activerecord, test-driven, auto-generated
  - - meta
    - property: og:title
      content: OpenRemote Rails API Documentation
  - - meta
    - property: og:description
      content: OpenRemote Rails API documentation with 50 components (22 models, 6 controllers, 7 services, 4 jobs, 11 concerns) and 514 test-driven examples. Auto-generated from code structure.
  - - meta
    - property: og:type
      content: website
---
...
**50 components** • **514 examples** • **100% test coverage**
...
- [Asset::References](/api/models/asset/references)
- [AssetType](/api/models/asset_type)
- [DataPoint](/api/models/data_point)
- [DataPoint::Analytics](/api/models/data_point/analytics)
- [DataPoint::BatchActions](/api/models/data_point/batch_actions)
- [DataPoint::References](/api/models/data_point/references)
- [FeatureGenerator](/api/models/feature_generator)
- [Notification](/api/models/notification)
- [Role](/api/models/role)
- [Rule](/api/models/rule)
- [Rule::Execution](/api/models/rule/execution)
- [Rule::References](/api/models/rule/references)
- [RuleExecution](/api/models/rule_execution)
- [TestExpectations](/api/models/test_expectations)
- [TestGenerator](/api/models/test_generator)
...
- [BatchActions](/api/concerns/batch_actions)
- [ConcernFeatures](/api/concerns/concern_features)
- [InteractionDocumentation](/api/concerns/interaction_documentation)
