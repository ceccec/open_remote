...
# Ability::Manager <Badge type="warning" text="Concern" />
...
::: info File Location
**Source:** `app/models/ability/manager.rb`
:::
...
- `define`(ability: CanCan::Ability, user: User) -> `void` - Define permissions for manager users.
