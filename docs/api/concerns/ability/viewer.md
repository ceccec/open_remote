...
# Ability::Viewer <Badge type="warning" text="Concern" />
...
::: info File Location
**Source:** `app/models/ability/viewer.rb`
:::
...
- `define`(ability: CanCan::Ability, user: User) -> `void` - Define permissions for viewer users.
