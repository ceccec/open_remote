---
title: Admin::RuleExecutionAdmin
description: RailsAdmin configuration for User model.
...
# Admin::RuleExecutionAdmin <Badge type="warning" text="Concern" />

RailsAdmin configuration for User model.

::: info File Location
**Source:** `app/models/concerns/admin/rule_execution_admin.rb`
:::
