...
description: Reference helpers for Rule model.
...
# Rule::References <Badge type="warning" text="Concern" />
...
::: info File Location
**Source:** `app/models/rule/references.rb`
:::
...
::: tip Get related rule executions
```ruby
rule.related_executions
```
:::

::: tip Get referenced assets
```ruby
