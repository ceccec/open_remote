---
title: Asset::Querying
description: Represents an asset in the OpenRemote system.
...
# Asset::Querying <Badge type="warning" text="Concern" />
...
::: info File Location
**Source:** `app/models/asset/querying.rb`
:::
